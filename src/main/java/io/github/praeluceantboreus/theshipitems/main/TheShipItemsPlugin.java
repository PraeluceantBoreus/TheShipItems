...
public class TheShipItemsPlugin extends JavaPlugin
{
	...
	private void genConfig()
	{
		...
		getConfig().addDefault("items.standard.pistol." + TheShipWeaponOption.THROW_DAMAGE, 1);
		...
		getConfig().addDefault("items.standard.dolch." + TheShipWeaponOption.THROW_DAMAGE, Material.REDSTONE_TORCH_ON.toString());
